...
namespace Presentation
{
    public partial class MainForm : BaseForms.BaseMainForm
    {
        ...
        public MainForm(UserModel userModel)
        {
            ...
            if(UserCache.puesto== Positions.Recepcionist|| UserCache.puesto == Positions.Couch)
            {
                btnUsers.Visible = false;
                btnAllClientes.Visible = false;
        ...
        public void LoadUserData(UserModel userModel)
        {
            ...
            lblName.Text = UserCache.UserName;
            lblLastName.Text = UserCache.NombreUsuario;
            lblPosition.Text = UserCache.puesto;
            //pictureBoxPhoto.Image = Properties.Resources.DefaultUserProfile;
        }
        ...
        {
            HideSubMenu();
            ShowSubMenu(panelMedios);
        }

        private void btnCalendar_Click(object sender, EventArgs e)
        {
            //OpenChildForm<FormCalendar>(sender);
        }
        ...
        private void btnHistPlanes_Click(object sender, EventArgs e)
        {
        ...
        {
            OpenChildForm<FormPlanes>(sender);
        }

        private void btnHorarios_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormHorarios>(sender);
        }

        private void btnAllClientes_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormClientes>(sender);
        }

        private void btnCheckCliente_Click(object sender, EventArgs e)
        {
            OpenChildForm<FormCheckInClient>(sender);
        }
        ...
        private void btnHistoryEntradas_Click(object sender, EventArgs e)
        {
